 ...
 * Please edit the config.php accordingly.
 */
	...
	<div class="container">
		...
		<div style="margin-top: 5px;">
			...
			if ( $config['logoType'] == 1 ) {
				echo "<p class=\"text-center\" style=\"font-size: 100px; color: #000;\">" . $config['name'] . "</p>";
			} else {
			...
			<div class="col-md-3">
				<div class="panel panel-success" style="margin-top: 5px;">
					...
					<div class="panel-body">
						<img src="<?php echo $fetch['avatarfull'] ?>" class="<?php echo "img-" . $config['avatarBorder']; ?> center-block" />
					</div>
				</div>
			</div>
			<!-- /First Panel -->
